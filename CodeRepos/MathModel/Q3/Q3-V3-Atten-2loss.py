...
model_load_path = r'/home/liuyangyang/MathModel/math-model-general/Code/Q3/model_path/' \
                  r'model_q3_base_v3_3km_done_2loss.pth'
model_continue_path = r'/home/liuyangyang/MathModel/math-model-general/Code/Q3/model_path/' \
                      r'model_q3_base_v3_3km_done1.pth'
train = True
# train = False
...
if train:
    ...
    input_data, target_data = dataset[30]
