...
class RadarDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        for frame in frames[number + seq_len: number + seq_len + seq_len]:
            frame_path = os.path.join(data_path, frame)
            data = np.load(frame_path)
            # if train is False:
...
model_load_path = r'/home/liuyangyang/MathModel/math-model-general/Code/Q4/model_path/model_q4.pth'
model_continue_path = r'/home/liuyangyang/MathModel/math-model-general/Code/Q4/model_path/model_q4.pth'
