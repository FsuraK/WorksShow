...
class RadarDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        target_data = []
        """ load target data based on different questions 1-4"""
        # # # questions 1, 2
        ...
        # target_data = np.stack(target_data, axis=0).reshape(1, 3, 256, 256)  # Shape: (1, 256, 256)
...
model_save_path = r'/home/liuyangyang/MathModel/math-model-general/Code/Q4/model_path/model_q4.pth'
model_load_path = r'/home/liuyangyang/MathModel/math-model-general/Code/Q4/model_path/model_q4_step3_MSE.pth'
model_continue_path = r'/home/liuyangyang/MathModel/math-model-general/Code/Q4/' \
                      r'model_path/model_q4_step3_nonormal_MSI.pth'
...
if train:
    ...
    for epoch in tq_bar:
        ...
        for batch_idx, (data, target) in enumerate(dataloader):
            ...
            loss = loss_MSE  # only loss_MSE for question 1
    ...
    #         df.to_excel(r'/home/liuyangyang/mathModelDataSet/data_output/test/q4'
    ...
    for i in range(1):
        ...
        df.to_excel(r'/home/liuyangyang/mathModelDataSet/data_output/test/q4' + f"/rain_pre_{i}.xlsx"
                    , index=False, header=False)
        df = pd.DataFrame(target_da)
        df.to_excel(r'/home/liuyangyang/mathModelDataSet/data_output/test/q4' + f"/rain_true_{i}.xlsx"
                    , index=False, header=False)
