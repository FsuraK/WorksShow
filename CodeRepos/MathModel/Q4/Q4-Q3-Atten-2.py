...
model_load_path = r'/home/liuyangyang/MathModel/math-model-general/Code/Q4/model_path/model_q4_ZDR.pth'
...
if train:
    ...
    for epoch in tq_bar:
        ...
        for batch_idx, (data, target) in enumerate(dataloader):
            ...
            # loss = criterion(outputs, target) + SSIMLoss(outputs, target)
    ...
    df.to_excel(r'/home/liuyangyang/mathModelDataSet/data_output/test/q4' + "/rain_output_ZDR.xlsx"
