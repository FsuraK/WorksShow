...
class RadarDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        frame_len = None
        number = 0
        for variable in ["ZDR"]:  # ["dBZ", "ZDR", "KDP"]
            ...
            for height in ["1.0km", "3.0km", "7.0km"]:
                ...
                if variable == "ZDR" and height == "1.0km":
                    number = number_
        ...
        input_data = np.stack(input_data, axis=0).reshape(3, 256, 256)  # Shape: (2, 256, 256)
...
model_save_path = r'/home/liuyangyang/MathModel/math-model-general/Code/Q4/model_path/model_q4_.pth'
model_load_path = r'/home/liuyangyang/MathModel/math-model-general/Code/Q4/model_path/model_q4_KDP.pth'
model_continue_path = r'/home/liuyangyang/MathModel/math-model-general/Code/Q4/model_path/model_q4_3in_good.pth'
# train = True
train = False
# continue_train = True
...
if train:
    ...
    for epoch in tq_bar:
        ...
        for batch_idx, (data, target) in enumerate(dataloader):
            ...
            loss = criterion(outputs, target) + criterion_add(outputs, target)
    ...
    df.to_excel(r'/home/liuyangyang/mathModelDataSet/data_output/test/q4' + "/rain_output_KDP.xlsx"
                , index=False, header=False)
    df = pd.DataFrame(target_data[-1].cpu().detach().numpy())
    df.to_excel(r'/home/liuyangyang/mathModelDataSet/data_output/test/q4' + "/rain_true_KDP.xlsx"
                , index=False, header=False)
