...
model_load_path = r'/home/liuyangyang/MathModel/math-model-general/Code/Q4/model_path/model_q4_3in_good.pth'
...
if train:
    ...
    df.to_excel(r'/home/liuyangyang/mathModelDataSet/data_output/test/q4' + "/rain_output.xlsx"
                , index=False, header=False)
    df = pd.DataFrame(target_data[-1].cpu().detach().numpy())
    df.to_excel(r'/home/liuyangyang/mathModelDataSet/data_output/test/q4' + "/rain_true.xlsx"
                , index=False, header=False)
