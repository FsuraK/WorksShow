...
class USV:
    ...
    def update_state(self, init_pos_=None, init_speed_=None, return_=False):
        ...
        c13 = -24.6612 * self.v[1] - 1.0948 * self.v[2]
        c31 = -c13
        c23 = 25.8 * self.v[0]
        c32 = -c23
        # self.D intermediate param
        d11 = 0.7225 + 1.3274 * abs(self.v[0]) + 5.8664 * self.v[0]**2
        d22 = 0.8612 + 36.2823 * abs(self.v[1]) + 8.05 * abs(self.v[2])
        d23 = -0.1079 + 0.845 * abs(self.v[1]) + 3.45 * abs(self.v[2])
        d32 = -0.1052 - 5.0437 * abs(self.v[1]) - 0.13 * abs(self.v[2])
        d33 = 1.9 - 0.08 * abs(self.v[1]) + 0.75 * abs(self.v[2])
